...
TXT: dict[str, tuple[str, str]] = {
    ...
    # Hauptchart
    "perf": ("Wert von 1.000 USD", "Value of USD 1,000"),
    ...
    "t_roll": ("Rollierende Überschussrendite", "Rolling excess return"),
    ...
    "roll_note": ("Annualisierte Differenz der Log-Renditen im rollierenden Fenster.",
                  "Annualised difference in log returns over a rolling window."),
    "hit": ("der {y}-Jahres-Fenster mit Outperformance",
            "of {y}-year windows with outperformance"),
    "conc": ("12 beste Monate im Verhältnis zum Gesamtvorsprung",
             "12 best months relative to the total lead"),
